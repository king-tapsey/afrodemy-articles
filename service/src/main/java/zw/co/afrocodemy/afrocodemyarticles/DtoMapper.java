...
import zw.co.afrocodemy.afrocodemyarticles.comment.Comment;
import zw.co.afrocodemy.afrocodemyarticles.comment.CommentReply;
import zw.co.afrocodemy.afrocodemyarticles.comment.CommentRepository;
import zw.co.afrocodemy.afrocodemyarticles.post.*;
...
public class DtoMapper {
    ...
    public Post dtoToPost(final PostDto postDto){
        ...
        post.setPostCommentPermission(postDto.getPostCommentPermission());
        return post;
    }
    public PostDto postToDto(final Post post){
        PostDto postDto = PostDto.builder()
                ...
                .postCommentPermission(post.getPostCommentPermission())
                .build();
        return postDto;
    }
